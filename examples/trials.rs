...
#
#   mira run --study examples/trials.rs
#
...
//!
//! ```bash
//! mira list --study examples/trials.rs                 # shows `trials=8, seed=…`
//! mira run --study examples/trials.rs                   # 8 trials per case, aggregated
//! mira run --study examples/trials.rs --trials 20       # override the count
//! mira run --study examples/trials.rs --seed 1          # different seed base, reproducible
//! mira run --study examples/trials.rs --format json --out report.json   # `trials` array in the record
//! ```
//!
