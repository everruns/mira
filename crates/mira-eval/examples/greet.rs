//! A minimal eval server, registered with `register_eval!` and served with
//! `serve_registered`. Run it under the host CLI:
//!
//! ```bash
...
use mira::{Eval, ModelSpec, Score, Transcript, register_eval};
